...
#将命令捷径放入缓存槽位
item replace block 0 -1 0 container.0 with minecraft:book{id:"shortcut:dark_fight_menu",CustomModelData:1,display:{Name:'[{"text":"诡秘挑战说明/辅助工具","color":"gold","italic":false}]',Lore:['{"translate":"book.byAuthor","with":["§6天道§7"],"color":"gray","italic":false}','{"translate":"book.generation.0","color":"gray","italic":false}']}}
#为命令捷径设置物品数量
